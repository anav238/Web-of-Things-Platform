...
public class VocabularyConstants {
    ...
    public static final String VCARD_URL = "http://www.w3.org/2001/vcard-rdf/3.0#";
    public static final String VCARD_PREFIX = "PREFIX vcard:      <" + VCARD_URL + ">";

    public static final String VCARD4_URL = "http://www.w3.org/2006/vcard/ns#";
    public static final String VCARD4_PREFIX = "PREFIX vcard4:      <" + VCARD4_URL + ">";
